...
HERO_STATIONS: list[dict[str, Any]] = [
    {
        "id": "monsoon_983",
        "station_name": "Monsoon 98.3",
        "reality_type": "earth",
        "year_or_era": "2004",
        "place": "Chennai, India",
        "broadcast_format": "late-night local FM",
        "dj_persona": "Anbu — warm, witty, conversational late-night host",
        "language_register": "warm Tamil-English code-mix",
        "music_blueprint": {
            "positive_global_styles": [
                "dreamy Tamil-inspired downtempo",
                "nocturnal pop texture",
                "warm Rhodes",
                "humid analog synths",
            ],
            "negative_global_styles": ["EDM drop", "trap hats", "metal", "vocals-in-English-only"],
            "tempo_bpm": 78,
        },
        "ad_economy": [
            "tea stalls",
        ...
        "headline_style": "soft local news, cricket scores, monsoon advisories",
        "weather_style": "humid rain bulletins from the Marina coast",
        "ambient_palette": ["rain on tin roofs", "scooters", "distant horns", "tea-stall chatter"],
        "signal_texture": "humid FM hiss",
        "station_slogan": "Late, lit, and a little damp.",
    ...
    {
        "id": "neon_siege",
        "station_name": "Neon Siege FM",
        "reality_type": "fictional",
        "year_or_era": "year-of-the-siege-7",
        "place": "Sector 9 — Drowned Megacity",
        "broadcast_format": "pirate cyberpunk panic station",
        "dj_persona": "Bex — wired, sarcastic insurgent DJ",
        "language_register": "synth-noir laconic, hacker slang",
        "music_blueprint": {
            "positive_global_styles": [
                "industrial synth",
                "dystopian breakbeats",
                "warped vocoder",
                "siren-tinted leads",
            ],
            "negative_global_styles": ["acoustic folk", "pop ballads", "cheerful brass"],
            "tempo_bpm": 138,
        },
        "ad_economy": [
            "blackmarket implants",
            "burner SIMs",
            "anti-surveillance jackets",
            "fake citizenship chips",
        ],
        "headline_style": "drone-strike countdowns, ration-queue intel, hacker bulletins",
        "weather_style": "acid rain bands, sector-wide brownout forecasts",
        "ambient_palette": [
            "rain on neon",
            "distant sirens",
            "drone hum",
        ...
        "signal_texture": "dirty pirate compression, signal stomp every 30s",
        "station_slogan": "Stay low. Stay loud.",
