...
def list_packs_endpoint(
    ...
    price_min_credits: int | None = Query(default=None, ge=0),
    price_max_credits: int | None = Query(default=None, ge=0),
    ...
    try:
        filters = PackFilters(
            ...
            tags=tags,
            moods=moods,
            price_min_credits=price_min_credits,
            price_max_credits=price_max_credits,
            q=q,
            sort=sort,
            limit=limit,
            offset=offset,
